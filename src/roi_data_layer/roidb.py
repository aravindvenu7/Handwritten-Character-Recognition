import numpy as np
import PIL
from src.fast_rcnn.config import cfg
from src.fast_rcnn.bbox_transform import bbox_transform
from src.ops.bbox import bbox_overlaps

def prepare_roidb(imdb):
    ##Enrich the imdb's roidb
